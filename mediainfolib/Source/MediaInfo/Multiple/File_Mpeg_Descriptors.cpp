...
namespace Elements
{
    ...
    const int32u DVB =0x00000001; // [IntelC++ 2012 beta2] Forced value, does not exist is stream // Source\MediaInfo\Multiple\File_Mpeg_Descriptors.cpp(72): warning #2415: variable "MediaInfoLib::Elements::DVB" of static storage duration was declared but never referenced
}
