...
#endif //WINDOWS
#endif // #ifdef FLYLINKDC_USE_MEDIAINFO_THREAD
...
Ztring MediaInfo_Internal::Get(stream_t StreamKind, size_t StreamPos, const String &Parameter, info_t KindOfInfo, info_t KindOfSearch)
{
    ...
    size_t ParameterI=MediaInfoLib::Config.Info_Get(StreamKind).Find(Parameter, KindOfSearch); // TODO - FlylinkDC++ Hot Point
    if (ParameterI==Error)
    {
