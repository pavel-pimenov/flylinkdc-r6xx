...
void File_Hevc::sei_message_user_data_registered_itu_t_t35_B5_003C_0001_04()
{
    ...
    bool IsHDRplus=false, tone_mapping_flag=false;
    ...
    if (application_version==1)
    {
        ...
        int16u fraction_bright_pixels=0;
        int8u num_distribution_maxrgb_percentiles=0, distribution_maxrgb_percentages[16], num_windows, num_bezier_curve_anchors=0;
