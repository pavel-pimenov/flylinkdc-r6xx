...
void File_Av1::sequence_header()
{
    ...
    int8u seq_profile, seq_level_idx[33], operating_points_cnt_minus_1, buffer_delay_length_minus_1=0, frame_width_bits_minus_1, frame_height_bits_minus_1, seq_force_screen_content_tools, BitDepth, color_primaries, transfer_characteristics, matrix_coefficients, chroma_sample_position;
    bool reduced_still_picture_header, seq_tier[33], timing_info_present_flag=false, decoder_model_info_present_flag=false, seq_choose_screen_content_tools, mono_chrome, color_range=0, color_description_present_flag, subsampling_x, subsampling_y;
    BS_Begin();
