...
public : //For very quick access, to not use except if you know what you do
    struct element_details
    {
		...
		element_details():Code(0),Next(0),WaitForMoreData(false),UnTrusted(false),IsComplete(false)
		{
		}
    };
...
public :
    ...
    public:
        ...
        size_t  Ibi_Read_Buffer_Seek        (size_t, int64u, int64u)            {return static_cast<size_t>(-1);}
        void    Ibi_Read_Buffer_Unsynched   ()                                  {}
        void    Ibi_Stream_Finish           ()                                  {}
